...
function Footer() {
  return (
    <div>
      <footer className="bg-gray-900 to-black">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-start text-white sm:justify-start">
                <svg
                  className="h-8"
                  viewBox="0 0 118 24"
                  fill="none"
              ...
              <p
                className="max-w-md mx-auto mt-6 leading-relaxed text-left text-white sm:max-w-xs sm:mx-0 sm:text-left"
            ...
            <div className="text-left sm:flex sm:justify-between sm:text-left">
              <div>
                <p className="text-sm text-white">
                  ...
                  <a
                    className="inline-block text-white underline transition hover:text-teal-500/75"
                    href="/"
                  >
                    Terms & Conditions
                  </a>
